...
class App:
    def __init__(self):
        ...
        self.db_dir = './face_attendance/db'
        if not os.path.exists(self.db_dir):
            os.mkdir(self.db_dir)

        self.log_path = './face_attendance/log.txt'
        
    def add_webcam(self, label):
        if 'cam' not in self.__dict__:
    ...
    def register_new_user(self):
        ...
        self.register_new_user_window.geometry("1200x520+70+120")
    ...
    def accept_register_new_user(self):
        ...
        util.msg_box('Saccess', 'User was registered successfully !')
        self.register_new_user_window.destroy()
